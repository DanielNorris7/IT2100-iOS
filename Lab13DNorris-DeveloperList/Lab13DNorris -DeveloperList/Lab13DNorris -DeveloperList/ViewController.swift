...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private func tableView(tableView: UITableView, titleForHeader section: Int) -> String? {
       
        let headerTitle = section == 0 ? "Web Developer" : "Mobile Developer";
        return headerTitle;
    }
    
    private func tableView(_ tableView: UITableView, hieghtForHeaderInSection section: Int) -> Int {
        return 50;
    }
    ...
    private func tableView(tableView: UITableView, didSelectRow indexPath: NSIndexPath) {
